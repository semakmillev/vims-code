...
from vims_code.db.schema import t_info_condition_list
...
class InfoConditionList(SqlTable):
    ...
    async def select(self, id: int = None, info_id: int = None, condition_code: str = None):
    ...
    async def clear_by_code(self, code_inner_id, level_id):
        sql = """delete from e_code.info_condition_list
                  ...
                  """
        await self.conn.execute(text(sql), dict(code_inner_id=code_inner_id, level_id=level_id))
